...
function setSkew(skew){
    $("canvas").css("transform", "skewY("+ skew+"deg)")
    $("h1").css("transform", "skewY("+ skew+"deg)")
    $("h3").css("transform", "skewY("+ skew+"deg)")
    $("h2").css("transform", "skewY("+ skew+"deg)")
    $("h4").css("transform", "skewY("+ skew+"deg)")
}


const setBack = debounce(function() {
    $("canvas").css("transform", "skewY(0deg)")
    $("h1").css("transform", "skewY(0deg)")
    $("h3").css("transform", "skewY(0deg)")
    $("h2").css("transform", "skewY(0deg)")
    $("h4").css("transform", "skewY(0deg)")
    },1000)
